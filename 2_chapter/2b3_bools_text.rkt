...
; whatever "crap" represents to a number. 
...
(define crap .) ;or "bonjour", etc...

(cond [(string? crap) (string-length crap)]
      [(number? crap) (if (> crap 0) (- crap 1) crap)]
      [(image? crap) (* (image-height crap) (image-width crap))]
      [(equal? crap true) 10]
      [(equal? crap false) 20])
; yay!!!! it werkz!!!